 ...
 */
var waitForFileMetaDataUpdate = function (app, filePath, key, callback) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, new Promise(function (resolve) {
                var inProgress = false;
                var onChanged = function (file) { return __awaiter(void 0, void 0, void 0, function () {
                    var meta;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                if (!meta || !meta.frontmatter || !(key in meta.frontmatter))
                                    return [2 /*return*/];
                                inProgress = true;
...
var waitForMetaDataCacheUpdate = function (app, callback) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, new Promise(function (resolve) {
                var inProgress = false;
                var onResolved = function () { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (inProgress)
